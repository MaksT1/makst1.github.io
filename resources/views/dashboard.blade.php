        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 ">
            ...
            <div class="mt-8 text-gray-900 mb-10">
                @foreach ($posts as $post)
                    <div
                        class="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mt-5 flex">
                        ...
                        <a href="#">
                            <img class="rounded-r-lg h-full w-48 object-cover"
